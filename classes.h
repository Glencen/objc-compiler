...
public:
    ...
    void analyzeIdentifierSemantics(SemanticContext& context);
    void analyzeLiteralSemantics(SemanticContext& context);
    void analyzeObjcArrayLiteralSemantics(SemanticContext& context);
    void analyzeObjcBoxedExprSemantics(SemanticContext& context);
    void analyzeNilSemantics(SemanticContext& context);
    void analyzeBoxedExprSemantics(SemanticContext& context);
    void analyzeMessageSemantics(SemanticContext& context);
    void analyzeSelfSemantics(SemanticContext& context);
    void analyzeUnaryMinusSemantics(SemanticContext& context);
    void analyzeNotSemantics(SemanticContext& context);
    void analyzePostIncSemantics(SemanticContext& context);
    void analyzePostDecSemantics(SemanticContext& context);
    void analyzeAdditionSemantics(SemanticContext& context);
    void analyzeSubtractionSemantics(SemanticContext& context);
    void analyzeMultiplicationSemantics(SemanticContext& context);
    void analyzeDivisionSemantics(SemanticContext& context);
    void analyzeEqualSemantics(SemanticContext& context);
    void analyzeNotEqualSemantics(SemanticContext& context);
    void analyzeGreaterSemantics(SemanticContext& context);
    void analyzeLessSemantics(SemanticContext& context);
    void analyzeLessOrEqualSemantics(SemanticContext& context);
    void analyzeGreaterOrEqualSemantics(SemanticContext& context);
    void analyzeAndSemantics(SemanticContext& context);
    void analyzeOrSemantics(SemanticContext& context);
    void analyzeAssignSemantics(SemanticContext& context);
    void analyzeArrayAccessSemantics(SemanticContext& context);
    void analyzeFunctionCallSemantics(SemanticContext& context);
    void analyzeDotSemantics(SemanticContext& context);
    void analyzeArrowSemantics(SemanticContext& context);
    void analyzeSemantics(SemanticContext& context) override;
